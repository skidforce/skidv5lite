...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/skidforce/skidv5lite/main/'..select(1, path:gsub('skidv5/', '')), true) end)
...
local vm = loadstring(downloadFile('skidv5/libraries/vm.lua'), 'vm')()
